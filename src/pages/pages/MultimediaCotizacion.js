...
function MultimediaCotizacion() {
  return (
    <React.Fragment>
      <Helmet title="Settings" />

      <Typography variant="h3" gutterBottom display="inline">
        GESTION BACKOFFICE - MULTIMEDIA COTIZACION
      </Typography>
...
export default MultimediaCotizacion;
