...
function TiposCuentaDeposito() {
  return (
    <React.Fragment>
      <Helmet title="Settings" />

      <Typography variant="h3" gutterBottom display="inline">
        GESTION BACKOFFICE - TIPO CUENTAS DEPOSITO
      </Typography>
...
export default TiposCuentaDeposito;
