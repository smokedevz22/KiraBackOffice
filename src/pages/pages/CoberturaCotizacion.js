...
import CoberturaProductos from "./CoberturasProductos";
...
function CoberturaCotizacion() {
  return (
    <React.Fragment>
      <Helmet title="Settings" />

      <Typography variant="h3" gutterBottom display="inline">
        GESTION BACKOFFICE - COBERTURA COTIZACION
      </Typography>
...
export default CoberturaCotizacion;
